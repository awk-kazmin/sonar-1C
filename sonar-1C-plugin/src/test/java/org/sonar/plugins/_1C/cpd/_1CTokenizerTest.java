...
public class _1CTokenizerTest {

  @Test
  public void test() {
    _1CTokenizer tokenizer = new _1CTokenizer(Charset.forName("UTF-8"));
    SourceCode source = mock(SourceCode.class);
    when(source.getFileName()).thenReturn(new File("src/test/resources/cpd/Person.bsl").getAbsolutePath());
