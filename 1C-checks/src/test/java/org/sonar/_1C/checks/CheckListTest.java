...
public class CheckListTest {
  ...
  public void count() {
    int count = 0;
    List<File> files = (List<File>) FileUtils.listFiles(new File("src/main/java/org/sonar/_1C/checks/"), new String[] {"java"}, false);
    for (File file : files) {
  ...
  public void test() {
    ...
    ResourceBundle resourceBundle = ResourceBundle.getBundle("org.sonar.l10n.1C", Locale.ENGLISH);
    ...
    for (Rule rule : rules) {
      ...
      assertThat(getClass().getResource("/org/sonar/l10n/1C/rules/1C/" + rule.getKey() + ".html"))
