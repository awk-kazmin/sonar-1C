...
public class _1CConfigurationModel extends AbstractConfigurationModel {

  private static final Logger LOG = LoggerFactory.getLogger(_1CConfigurationModel.class);
  ...
  @VisibleForTesting
  _1CConfiguration getConfiguration() {
    return new _1CConfiguration(getCharset());
  }
